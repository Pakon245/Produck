...
function Login() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // คุณสามารถใส่ logic การ login ที่นี่ เช่น ส่งข้อมูลไปที่ backend
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-2 mt-1 border rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
            />
          </div>
          <div>
